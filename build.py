...
mod is NOT compatible with other overhaul mods such as:\nArsenal+\n\
Captain's Edition\nCaptain's Remix\nStation's Job or others\n\nIf you \
want to contribute to the mod, fork the project or use assets in your own \
mod, follow the Github link. Everyone is welcome!"
ProtectedXML = ( 
    'achievements.xml', 
