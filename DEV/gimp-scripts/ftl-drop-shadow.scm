...
(define (script-fu-ftl-shadow image
                               drawable
                               shadow-transl-x
                               shadow-transl-y
                               shadow-blur
  ...
  (gimp-layer-set-lock-alpha shadow-layer TRUE) ; Added these 4 strings
...
(script-fu-register "script-fu-ftl-shadow"
  _"FTL Glow"
  ...
  SF-ADJUSTMENT _"Offset X"       '(0 -4096 4096 1 10 0 1)
  SF-ADJUSTMENT _"Offset Y"       '(0 -4096 4096 1 10 0 1)
  SF-ADJUSTMENT _"Blur radius"    '(30 0 1024 1 10 0 1)
  SF-COLOR      _"Color"          '(255 170 186)
  SF-ADJUSTMENT _"Opacity"        '(30 0 100 1 10 0 0)
  SF-TOGGLE     _"Allow resizing" TRUE
)

(script-fu-menu-register "script-fu-ftl-shadow"
